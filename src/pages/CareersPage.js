        ...
        <div>
            <Header />
                ...
                <div className='coffee-story'>
                    ...
                    <p className='positions-section-desc'>
                    {languageMap[globalVariable]?.text57a}<a style={{color:"#05A8D9"}} href="mailto:ibizahouse@nakedground.coffee">ibizahouse@nakedground.coffee</a>  {languageMap[globalVariable]?.text57b}                    
                    </p>
                </div>
                <div className='positions-section'>
                    <h2 className="hh2">{languageMap[globalVariable]?.text62}</h2>
                    {jobPositions[globalVariable].map(list=>(
                        <Job key={list.jobPosition} jobPosition={list.jobPosition}  jobType = {list.jobType} jobDescription = {list.jobDescription}/>
                    ))}
                </div>
            <Footer/>            
        </div>
