    ...
    <div className="App">
      <div className="div1-announcment">
        <div className="div-announcment">
          <p className="p-announcment">
            <a className="a-announcment" href="">
              FREE DELIVERY OVER £30 - SHOP NOW
            </a>
          </p>
        </div>
      </div>
      <header className="header-home">
        <div className="header-wrapper">
          <div className="header-left-links">
            <button
              className="header-open-navigation"
            ...
            <nav
              className="header-main-navigation"
              aria-label="Main navigation"
            >
              <ul className="header-main-navigation-ul">
                <li className="header-main-navigation-li">
                  <a
                    className="header-main-navigation-li-a"
                    href="https://www.tripadvisor.com/Restaurant_Review-g642208-d24851249-Reviews-COFFEE_GROUND-Santa_Eulalia_del_Rio_Ibiza_Balearic_Islands.html#REVIEWS"
                  >
                    Our Houses
                  </a>
                </li>
                ...
                <li className="header-main-navigation-li">
                  <a
                    className="header-main-navigation-li-a"
                    href="https://cdn.shopify.com/s/files/1/0598/9367/8286/files/COFFEE_Ground_A3_Food_Menu_-_English_trim_bleed.pdf?v=1680277399"
                  >
                    Menu
                  </a>
                </li>
          ...
          <div className="header-center-links">
            <h1 className="header-center-links-h1-a-img">COFFEE GROUND</h1>
          </div>
      ...
      <header className="mob-header">
        <div className="header-wrapper">
            ...
            <section className="ph-section-side">
              <header className="ph-section-side-header">
                <button
                  ...
                  className="ph-section-side-header-button"
                  aria-label="Close navigation"
                >
                  <svg
                    className="ph-close-icon"
                    role="presentation"
                    viewBox="0 0 16 14"
                  >
                    <path
              ...
              <div className="ph-section-side-main">
                <div className="ph-section-side-main-links">
                  <nav
                    className="ph-section-side-main-links-nav"
                    ...
                    <div className="ph-section-side-main-links-link">
                      <button className="ph-section-side-main-links-link-button">
                        <a
                          className="header-main-navigation-li-a"
                          style={{ color: "#fff" }}
                          href="https://www.tripadvisor.com/Restaurant_Review-g642208-d24851249-Reviews-NAKED_GROUND-Santa_Eulalia_del_Rio_Ibiza_Balearic_Islands.html#REVIEWS"
                        >
                          Our Houses
                        </a>
                      </button>
                    ...
                    <div className="ph-section-side-main-links-link">
                      <button className="ph-section-side-main-links-link-button">
                        <a
                          className="header-main-navigation-li-a"
                          style={{ color: "#fff" }}
                          href="https://cdn.shopify.com/s/files/1/0598/9367/8286/files/Naked_Ground_A3_Food_Menu_-_English_trim_bleed.pdf?v=1680277399"
                        >
                          Menu
                        </a>
                      </button>
                  ...
                  <ul className="footer-div-div-div1-ul">
                    <li
                      className="footer-div-div-div1-ul-li"
                      style={{ color: "white" }}
                    >
                      <a
                        className="footer-div-div-div1-ul-li-a"
                        href="https://www.facebook.com/refy/"
                        target="_blank"
                      ...
                      >
                        <span>
                          <svg
                            className="footer-div-div-div1-ul-li-a-svg"
                            role="presentation"
                            viewBox="0 0 9 17"
                          >
                    ...
                    >
                      <a
                        className="footer-div-div-div1-ul-li-a"
                        href="https://www.tiktok.com/@nakedground.es"
                        target="_blank"
                        rel="noopener noreferrer"
          ...
          <h1
            className="header-center-links-h1-a-img"
            ...
            <div className="main-div1-section-div">
              <div className="main-div1-section-div-div">
                ...
                <div className="main-div1-section-div-div-p">
                  <p>
                    "COFFEE GROUND is more than coffee; we are a place where you
                    belong. COFFEE GROUND is a daily habit which brings
                    positivity and company to everyone's day"
                  </p>
                </div>
          ...
          <section className="main-div3-section">
            <div className="main-div3-section-div">
              <header className="main-div3-section-div-header">
                <h3 className="main-div3-section-div-header-h3">SHOP NOW</h3>
            ...
            <div className="main-div4-section-div">
              ...
              <div className="main-div4-section-div-div1">
                <div className="main-div4-section-div-div1-div">
                  <a className="main-div4-section-div-div1-div-a" href="#">
                    SHOP COLLECTION
                  </a>
                </div>
              </div>
          ...
          <div className="footer-div">
            <div className="footer-div-div">
              <div className="footer-div-div-div1">
                <h2 className="footer-div-div-div1-h2">COFFEE GROUND</h2>
              ...
              <div className="footer-div-div-div2">
                ...
                <ul className="footer-div-div-div2-ul">
                  <li className="footer-div-div-div2-ul-li">
                    <a
                      className="footer-div-div-div2-ul-li-a"
                      href="https://www.tripadvisor.com/Restaurant_Review-g642208-d24851249-Reviews-NAKED_GROUND-Santa_Eulalia_del_Rio_Ibiza_Balearic_Islands.html#REVIEWS"
                    >
                      Our Houses
                    </a>
                  ...
                  <li className="footer-div-div-div2-ul-li">
                    <a className="footer-div-div-div2-ul-li-a" href="#">
                      Privacy Policy
                    </a>
                  </li>
                  <li className="footer-div-div-div2-ul-li">
              ...
              <form className="footer-div-div-div3">
                ...
                <p>
                  Enter your email address for a chance to win a free holiday to
                  Ibiza!
                </p>
                <div>
                  <input
            ...
            <div className="footer-buttom">
              <a className="footer-buttom-a" href="/">
                © COFFEE GROUND
              </a>
            </div>
          </div>
