    ...
    <div>
      ...
      <div style={{ paddingBlockStart: "77px", backgroundColor: "#EAF7FC" }}>
        ...
        <div className="user">
          <p
            className="purpose-p"
            style={{ maxWidth: "690px", textAlign: "center" }}
          >
          ...
          {status ? (
            ...
            <form
              className="footer-colum"
              style={{ gap: "18px" }} /*onSubmit={sendEmail}*/
            >
              <input
                className="subscribe-input"
                type="name"
                aria-label={languageMap[globalVariable]?.text54}
                placeholder={languageMap[globalVariable]?.text54}
                required
                value={name}
              ...
              <input
                className="subscribe-input"
                type="email"
                aria-label={languageMap[globalVariable]?.text55}
                placeholder={languageMap[globalVariable]?.text55}
                required
                value={email}
