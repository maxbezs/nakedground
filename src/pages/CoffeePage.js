...
import coffeeVideo from "../images/COFFEE-video.mp4";
  ...
  return (
    <div>
      ...
      <div className="coffeee-section">
        <h1 className="hh2">{languageMap[globalVariable]?.text19}</h1>
        <p className="hh2-span">{languageMap[globalVariable]?.text20}</p>
        <div className="bean-p-div">
          <p className="bean-p">{languageMap[globalVariable]?.text50}</p>
          <hr className="hr-coffee" />

          <p className="bean-p">{languageMap[globalVariable]?.text50a}</p>
        </div>
      </div>
      ...
      <div className="coffee-story">
        <p className="bean-p">{languageMap[globalVariable]?.text51}</p>
        <hr className="hr-coffee" />
        <p className="bean-p">{languageMap[globalVariable]?.text51a}</p>
      </div>
      <Footer />
    </div>
  );
